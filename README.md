...
# [Built Portfolio With GitHub ](https://github.com/satyamlucifer/Portfolio)
...
### Then, Customize data in the `utils/data` [folder](https://github.com/satyamlucifer/Portfolio/tree/main/utils/data).
...
export const personalData = {
  ...
  leetcode: "https://leetcode.com/lucifer321/",
  devUsername: "satyamlucifer",
  resume: "...",
};
```
